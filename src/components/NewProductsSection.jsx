    ...
    return (
        <section className="py-12 bg-gray-50 text-center">
            <div className="max-w-7xl mx-auto px-6 relative">
                ...
                <p className="text-gray-400 text-sm">Les nouveautés arrivent bientôt !</p>
            </div>
        </section>
    );
  }
          ...
          {displayProducts.map((product, idx) => (
            ...
            >
              <div className="relative h-[180px] w-full bg-white flex items-center justify-center overflow-hidden">
                ...
                />
                <div className="absolute top-0 left-0 bg-[#003D7A] text-white text-[11px] font-bold px-2 py-1 rounded-br-lg shadow-sm">
                  NOUVEAU
                </div>
              </div>
